    ...
    <nav class="navbar navbar-custom navbar-static-top" role="navigation" style="background-color: #e3f2fd;">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${contextPath}/index">Pankaj Sharma Devops Expert</a>
            </div>
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:864px">
	     <p style="text-align:justify;">
                    Pankaj Sharma is a dynamic software company dedicated to delivering innovative technology solutions. Founded with a mission to leverage cutting-edge technology and unparalleled expertise, we specialize in creating high-quality software solutions that drive business success.
                </p>
                <p style="text-align:justify;">
                ...
                <p style="text-align:justify;">
                    At Pankaj Sharma, we focus on understanding our clients' unique needs and providing tailored solutions that meet their objectives. Whether it's custom software development, system integration, or ongoing support, we are committed to excellence and client satisfaction.
                </p>
                <p style="text-align:justify;">
                    With a commitment to staying ahead of technological trends and a passion for innovation, Pankaj Sharma is your trusted partner in navigating the digital landscape and achieving your business goals.
                </p>
                <p><strong>Address:</strong> Lalru Mandi, Punjab</p>
                <p><strong>Phone:</strong> +91-9728082087</p>
                <p><strong>Email:</strong> rersharma@gmail.com</p>
  	</div>
   </div>
